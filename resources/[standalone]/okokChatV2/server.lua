...
if Config.EnableMeCommand then
	RegisterCommand(Config.MeCommand, function(source, args, rawCommand)
		...
		-- 			template = '<div class="chat-message me"><i class="'..Config.MeIcon..'"></i> <b><span style="color: #FFFFFF">['..Config.MeMessageTitle..'] {0}</span>&nbsp;<span class="time">{2}</span></b><div class="message">{1}</div></div>',
