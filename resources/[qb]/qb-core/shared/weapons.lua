...
----rubberen guns
[`WEAPON_SIGMCX`]               = { name = 'WEAPON_SIGMCX', label = 'stigma', weapontype = 'Pistol', ammotype = 'AMMO_PISTOL', damagereason = 'Died' },
[`WEAPON_PDP`]               = { name = 'WEAPON_PDP', label = 'pdp', weapontype = 'Pistol', ammotype = 'AMMO_PISTOL', damagereason = 'Died' },
[`WEAPON_BERETTA92`]               = { name = 'WEAPON_BERETTA92', label = 'beretta92', weapontype = 'Pistol', ammotype = 'AMMO_PISTOL', damagereason = 'Died' },

-- custom guns
[`weapon_colbaton`]               = { name = 'weapon_colbaton', label = 'colbaton', weapontype = 'Melee', ammotype = nil, damagereason = 'Died' },
[`weapon_karambitknife`]               = { name = 'weapon_karambitknife', label = 'karambitknife', weapontype = 'Melee', ammotype = nil, damagereason = 'Died' },
[`weapon_perforator`]               = { name = 'weapon_perforator', label = 'perforator', weapontype = 'Melee', ammotype = nil, damagereason = 'Died' },

[`weapon_remington`]               = { name = 'weapon_remington', label = 'remington', weapontype = 'Shotgun', ammotype = 'AMMO_SHOTGUN', damagereason = 'Died' },
[`weapon_scarh`]               = { name = 'weapon_scarh', label = 'scarh', weapontype = 'Rifle', ammotype = 'AMMO_RIFLE', damagereason = 'Died' },
[`weapon_sledgehammer`]               = { name = 'weapon_sledgehammer', label = 'sledgehammer', weapontype = 'Melee', ammotype = nil, damagereason = 'Died' },
[`weapon_ak47`]               = { name = 'weapon_ak47', label = 'ak47', weapontype = 'Rifle', ammotype = 'AMMO_RIFLE', damagereason = 'Died' },
