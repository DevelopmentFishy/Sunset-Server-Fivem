...
Config.TabletPassword = "sunsetbanktruck"              -- Password for tablet
...
Config.PercentForCrimeFromWholeLoot = 100    -- How many % of the whole loot the crime player will get after heist complete
...
Config.MinimunFriendsToStartHeist = 0           -- Set Minimum friends count required to start the heist. 
Config.MinimumCopsToStartHeist = 3              -- Set Minimum cops on duty count required to start heist
...
Config.Clothes = {
    male = {
        ...
        ["t-shirt"] = {clotheId = 153, variation = 0},
        ["torso"] = {clotheId = 139, variation = 7},
        ["kevlar"] = {clotheId = 60, variation = 8},
        ["decals"] = {clotheId = 0, variation = 0},
    },
    
    female = {
        ["mask"] = {clotheId = 0, variation = 0},
        ["arms"] = {clotheId = 36, variation = 0},
        ["pants"] = {clotheId = 34, variation = 0},
        ["bag"] = {clotheId = 45, variation = 0},
        ["shoes"] = {clotheId = 101, variation = 0},
        ["t-shirt"] = {clotheId = 189, variation = 0},
        ["torso"] = {clotheId = 136, variation = 7},
        ["kevlar"] = {clotheId = 61, variation = 8},
        ["decals"] = {clotheId = 0, variation = 0},
    }
}
...
Config.Lang = {
    ...
    ["startingTutorial"] = "De taak omvat het transporteren van contant geld van de bronbank of locatie naar de bestemmingsbank. Ga naar de aangewezen locatie voor meer informatie. Bedenk dat dit een gevaarlijke klus is, je kunt talloze overvalpogingen verwachten.",
    ["beforeMoneyGrabInBank"] =   "Uw eerste stap is het verzamelen van contant geld uit de karren in de kluis. U kunt geen enkele rekening missen en u kunt ook niemand opgesloten in de kluis achterlaten. Vergeet niet de kluisdeur te sluiten als u weggaat",
    ["beforeMoneyGrab"] =   "Je eerste stap is het verzamelen van contant geld uit de karren. U kunt geen enkele rekening missen. Nadat u ze allemaal heeft geïnd, worden de volgende stappen uitgelegd",
    ["afterMoneyGrabTutorialInBank"] = "Je hebt al het geld uit de kluis gepakt. Sluit nu de kluisdeur en plaats de zakken met geld in de kofferbak van de auto. Volg de procedures. Als u de tassen niet neerzet, kunt u de auto niet verplaatsen.",
    ["afterMoneyGrabTutorial"] = "Je hebt al het geld uit de karren gepakt. Plaats nu de zakken met geld in de kofferbak van de auto. Volg de procedures. Als u de tassen niet neerzet, kunt u de auto niet verplaatsen.",
    ["afterBagLoadingTutorial"] = "Zakken geladen. Vanaf nu kunt u het voertuig verplaatsen. Ga naar de gemarkeerde plaats om de tassen af ​​te leveren!",
    ["afterDeliveringBagsTutorial"] = "Je hebt de tassen bij de kluis afgeleverd. Dit is waar jouw werk eindigt. Sluit de deur van de kluis en ga naar de basis om betaald te worden",
    ["AfterArrivalToTargetBank"] = "Jij benaderde de doelbank, wij ontgrendelden de mogelijkheid om de achterdeur te openen. Ga naar de achterkant van de kar om de deur te openen, pak je koffers en ga naar de kluis",
    ["afterAttack"] = "Je bent aangevallen. Uw geld wordt waarschijnlijk gestolen. Ga niet verder met werken, keer terug naar de basis",
    ["notReadyWarning"] = "Het werk is niet voltooid. U kunt de dienst nu verlaten, maar er wordt een boete in rekening gebracht en uw salaris wordt niet uitbetaald.",
    ["wrongCarWarning"] = "Dit is niet uw bedrijfswagen. U kunt de klus nog steeds afmaken, maar er wordt een boete in rekening gebracht",
    ["cantOpenTabletWhileOnDuty"] = "U kunt deze tablet niet openen terwijl u onderweg bent",
    ["alreadyBusy"] = "Je kunt geen overval beginnen omdat je dienst hebt of al een overval pleegt", 
...
Config.BankLocations = {
    ...
    [1] = {
        rewardBonus = 0,
        isVault = true,
        DriverCoords = vec3(146.72, -1046.02, 29.37),
    ...
    [2] = {
        rewardBonus = 0,
        isVault = true,
        DriverCoords = vec3(-353.97, -55.26, 49.04),
    ...
    [3] = {
        rewardBonus = 0,
        isVault = true,
        DriverCoords = vec3(-2956.57, 481.55, 15.70),
    ...
    [4] = {
        rewardBonus = 0,
        isVault = true,
        DriverCoords = vec3(311.19, -284.38, 54.16),
    ...
    [5] = {
        rewardBonus = 0,
        isVault = true,
        DriverCoords = vec3(-1210.92, -336.63, 37.78),
    ...
    [6] = {
        rewardBonus = 0,
        isVault = true,
        DriverCoords = vec3(1176.13, 2712.86, 38.09),
