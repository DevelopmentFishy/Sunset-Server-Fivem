...
Config.MinimumRevive = 240                                   -- How long the timer is for players to revive a player in laststand
...
Config.ArmorDamage = 50                                       -- Minumum damage done to armor before checking for injuries
...
Config.FadeOutTimer = 5000                                   -- How many bleed ticks occur before fadeout happens
Config.BlackoutTimer = 5000                                  -- How many bleed ticks occur before blacking out
...
Config.DamageMinorToMajor = 55      -- How much damage would have to be applied for a minor weapon to be considered a major damage event. Put this at 100 if you want to disable it
Config.AlertShowInfo = 2            -- How many injuries a player must have before being alerted about them

Config.Locations = {                -- Edit the various interaction points for players or create new ones
    ['checking'] = {
        [1] = vector3(302.20, -589.61, 43.27),
        --[2] = vector3(-254.54, 6331.78, 32.43), -- paleto
    },
    ['duty'] = {
        [1] = vector3(302.18, -591.33, 43.27),
    ...
    ['stash'] = {
        [1] = vector3(313.88, -587.60, 38.33),
    },
    ['beds'] = {
        { coords = vector4(323.32, -568.72, 49.11, 159),    taken = false, model = 1631638868 },
        { coords = vector4(319.99, -567.52, 49.11, 159),    taken = false, model = 1631638868 }, 
        { coords = vector4(316.76, -566.33, 49.11, 159),    taken = false, model = 1631638868 },
        { coords = vector4(318.15, -572.16, 49.11, 340),    taken = false, model = 1631638868 },
...
Config.Items = { -- Grade is key, don't add same item in multiple grades. Higher rank can see lower
    [0] = {
        ...
        { name = 'handcuffs', price = 0, amount = 50, info = {}, type = 'item' },
        { name = 'tracker', price = 0, amount = 50, info = {}, type = 'item' },
    }
}
