...
RegisterNetEvent('hospital:server:SendToBed', function(bedId, isRevive)
	...
	exports['okokBanking']:AddMoney('ambulance', 'Player treatment')
...
QBCore.Commands.Add('112m', Lang:t('info.ems_report'), { { name = 'Medische bijstand', help = Lang:t('info.message_sent') } }, false, function(source, args)
	local src = source
	local message
