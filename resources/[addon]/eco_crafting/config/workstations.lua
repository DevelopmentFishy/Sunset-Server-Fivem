...
Config.workstations = {
    ...
    {
        workstation = 'weaponry',
        pos = vector4(-1837.39, 2915.39, 41.34, 60.85),
        animation = {
            dict = 'anim@amb@clubhouse@tutorial@bkr_tut_ig3@',
            anim = 'machinic_loop_mechandplayer',
            flag = 16
...

    {
        ...
        pos = vector4(-213.54, -1334.09, 30.89, 178),
        animation = {
            dict = 'anim@amb@clubhouse@tutorial@bkr_tut_ig3@',
            anim = 'machinic_loop_mechandplayer',
            flag = 16
    ...
    {
        workstation = 'handicraft',
        pos = vector4(728.33, -1069.06, 28.31, 269.64),
        animation = {
            dict = 'anim@amb@clubhouse@tutorial@bkr_tut_ig3@',
            anim = 'machinic_loop_mechandplayer',
            flag = 16
    ...
    {
        workstation = 'handicraft',
        pos = vector4(1182.79, 2635.3, 37.75, 180.4),
        animation = {
            dict = 'anim@amb@clubhouse@tutorial@bkr_tut_ig3@',
            anim = 'machinic_loop_mechandplayer',
            flag = 16
    ...
    {
        workstation = 'handicraft',
        pos = vector4(-1165.75, -2019.2, 13.18, 135.63),
        animation = {
            dict = 'anim@amb@clubhouse@tutorial@bkr_tut_ig3@',
            anim = 'machinic_loop_mechandplayer',
            flag = 16
    ...
    {
        workstation = 'handicraft',
        pos = vector4(101.46, 6624.63, 31.79, 43.82),
        animation = {
            dict = 'anim@amb@clubhouse@tutorial@bkr_tut_ig3@',
            anim = 'machinic_loop_mechandplayer',
            flag = 16
    ...
    {
        workstation = 'handicraft',
        pos = vector4(2353.77, 3118.35, 48.21, 351),
        animation = {
            dict = 'anim@amb@clubhouse@tutorial@bkr_tut_ig3@',
            anim = 'machinic_loop_mechandplayer',
            flag = 16
