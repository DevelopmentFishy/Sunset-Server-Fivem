...
local SandwichToBeer = {
    tradeName = 'Wiet',
    fromItems = {
        { name = 'geldrol', amount = 20000 },
    },
    toItems = {
        { name = 'weed_access', amount = 1 }
    },
}
...
--     tradeName = 'moneybag',
--     fromItems = {
--         { name = 'moneybag', amount = 1 }
--     },
--     toItems = {
--         { name = 'geldrol', amount = 1000 }
--     },
-- }
...
local PhoneToCash = {
    tradeName = 'Meth',
    fromItems = {
        { name = 'geldrol', amount = 75000 },
    },
    toItems = {
        { name = 'meth_access', amount = 1}
    },
}
...
local FoodToGolfClub = {
    tradeName = 'Coke',
    fromItems = {
        {name = 'geldrol', amount = 50000}
    },
    toItems = {
        { name = 'coke_access', amount = 1 }
    },
}
