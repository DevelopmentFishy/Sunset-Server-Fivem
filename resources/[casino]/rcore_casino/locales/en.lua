Translation["en"] = {
    ...
    BAR_MENU_DESC2 = "Bestel een kleine snack bij de bar",
    ...
    BAR_ASK_SHOT = "Druk op ~INPUT_TALK~ om één keer te vragen. Druk op ~INPUT_CELLPHONE_CANCEL~ om te vertrekken",
