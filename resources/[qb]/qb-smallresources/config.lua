...
Config.PauseMapText = 'Sunset Roleplay' -- Text shown above the map when ESC is pressed. If left empty 'FiveM' will appear
...
Config.Discord = {
    ...
    applicationId = '1026192236645449859', -- The discord application id
    iconLarge = 'logo', -- The name of the large icon
    iconLargeHoverText = 'Sunset', -- The hover text of the large icon
    iconSmall = 'fivem-logo', -- The name of the small icon
    iconSmallHoverText = 'Sunset RP', -- The hover text of the small icon
    updateRate = 60000, -- How often the player count should be updated
    showPlayerCount = true, -- If set to true the player count will be displayed in the rich presence
    maxPlayers = 64, -- Maximum amount of players
    buttons = {
        {
            text = 'Join onze discord!',
            url = 'https://discord.gg/RSeNtcZKZY'
        }
    }
}
...
Config.WeapDraw = {
    variants = {197, 209, 186, 183, 9, 8, 6, 1, 146},
    weapons = {
        'WEAPON_STUNGUN',
        'WEAPON_PISTOL',
        'WEAPON_PISTOL_MK2',
...
Config.Teleports = {
    [1] = { -- Elevator @ Mechanic
        [1] = { -- up
            poly = {coords = vector3(-899.86, -789.12, 15.27), heading = 359.99, length = 2, width = 2},
        ...
        [2] = { -- down
            poly = {coords = vector3(-927.45, -759.49, 28.48), heading = 184.27, length = 2, width = 2},
            allowVeh = false,
            label = false
        }
    },
    [2] = { -- Elevator @ Mechanic
       [1] = { -- up
        poly = {coords = vector3(338.72, -583.83, 74.16), heading = 244.42, length = 2, width = 2},
        allowVeh = false, -- whether or not to allow use in vehicle
        label = false -- set this to a string for a custom label or leave it false to keep the default. if more than 2 options, label all options

    },
    [2] = { -- down
        poly = {coords = vector3(316.93, -577.08, 43.28), heading = 78.88, length = 2, width = 2},
        allowVeh = false,
        label = false
    }
}
...
Config.CarWash = {
    ...
    defaultPrice = 5, -- default price for the carwash
    locations = {
