...
local function GetDeliveryLocation()
    ...
    PolyZone:onPlayerInOut(function(isPointInside)
        if isPointInside then
            inRange = true
            exports["jg-textui"]:DrawText(Lang:t('info.busstop_text'), 'rgb(220, 20, 60)')
            ...
            if isPointInside then
                ...
                CreateThread(function()
                    repeat
                        Wait(5)
                        if not inVeh then
                            exports["jg-textui"]:DrawText(Lang:t('info.busstop_text'), 'left')
                            ...
                            exports["jg-textui"]:DrawText(Lang:t('info.bus_stop_work'), 'left')
                            if IsControlJustReleased(0, 38) then
