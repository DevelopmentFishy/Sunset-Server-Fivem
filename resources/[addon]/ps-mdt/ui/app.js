...
var quotes = [
  'Alles is grappig, zolang het iemand anders overkomt.- Will Rogers',
  'Het enige wat je met liegen bereikt is niet geloofd worden als je de waarheid spreekt. - Aristoteles',
  'Anne, als ik jou zie ben ik niet meer bij te sturen - Koen Wauters',
  'Als je troebel water met rust laat, wordt het vanzelf helder - Loa-Tse',
  'Een mens heeft twee oren en één mond om twee keer zoveel te luisteren dan te praten. - Confucius',
  'Ik geef je nooit op. - Rick Astley',
  'De beste tijd om een boom te planten was 20 jaar geleden. De tweede beste tijd is vandaag.',
  'Twijfel is het begin van wijsheid. - Aristoteles',
  'Je mist 100% van de schoten die je niet afvuurt.',
  'Wie rijk wil zijn, moet niet zijn vermogen vermeerderen maar zijn hebzucht verminderen. - Epicurus',
  ...
  'De enigste goeie crim is een dooie crim. - Vik De Flik',
  'Nutella heeft weinig vitaminen, dus je moet er veel van eten.',
  'Geloof niet alles wat je leest op het internet. - Sir Isaac Newton',
  'Ik hou van lange wandelingen, vooral als ze worden gemaakt door mensen die me irriteren. - Noel Coward',
  'Als vrouwen de wereld zouden besturen, zou er geen oorlog meer zijn, wel intense onderhandelingen om de 28 dagen. - Robin Williams',
  'Politici en luiers moeten vaak worden gewisseld en om dezelfde reden. - Mark Twain',
  'Als een man een autodeur opent voor zijn vrouw, is het een nieuwe auto of een nieuwe vrouw. - Philip Mountbatten',
  'Ik heb niet gefaald, ik heb net 10.000 manieren gevonden die niet werken. - Thomas Edison',
  'Door trouw acht uur per dag te werken, kun je uiteindelijk de baas worden en twaalf uur per dag werken. - Robert Frost',
  'Ga naar de hemel voor het klimaat en naar de hel voor het gezelschap. - Mark Twain',
  'Onthoud altijd dat je absoluut uniek bent, net als iedereen. - Margaret Mead',
  'Rijst is geweldig als je honger hebt en je wilt 2.000 van iets. - Mitch Hedberg',
  'Ik vergeet nooit een gezicht, maar in jouw geval maak ik graag een uitzondering. - Groucho Marx',
  'Geduld is iets wat je bewondert in de bestuurder achter je, maar niet in die voor je. - Bill McGlashan',
  'Een koopje is iets dat je niet nodig hebt voor een prijs die je niet kunt weerstaan. - Franklin Jones',
  'Het is waar dat hard werken nooit iemand heeft gedood, maar waarom zou je het risico lopen? - Ronald Reagan',
  'Ik kook met wijn en soms voeg ik het zelfs toe aan het eten. - William Claude Dukenfield',
  'Achter elke grote man rolt een vrouw met haar ogen. - Jim Carrey',
  'Leen altijd geld van een pessimist; hij verwacht het niet terug. - Oscar Wilde',
  'Kennis is weten dat een tomaat een vrucht is, wijsheid is het niet in een fruitsalade stoppen. - Miles Kingston',
  'Neem het leven niet te serieus; je komt er nooit levend uit. Elbert Hubbard',
  'Van alle dingen die ik kwijt ben, mis ik mijn verstand het meest. - Ozzy Osbourne',
  'Ik heb mijn vrouw al jaren niet meer gesproken: ik wilde haar niet onderbreken. - Rodney Dangerfield',
  'Stel nooit uit tot morgen wat je overmorgen net zo goed kunt doen.  -Mark Twain',
  'Ik kan alles weerstaan, behalve verleiding. - Oscar Wilde',
  'Pannenkoek! - Elke Luciano',
  'Het is niet voor mij het is voor mijn eenzaamheid. - Man Van Melle', 
  'De meeste dromen zijn bedrog. - Marco Borsato',
]
...
$(document).ready(() => {
  ...
  $(".profile-items").on("click", ".profile-item", async function () {
    ...
    $(".manage-profile-editing-title").html(`Je bent het profiel van ${result["firstname"]} ${result["lastname"]} aan het bewerken`);
    ...
    let licencesHTML = '<div style="color: #fff; text-align:center;">Geen Vergunningen</div>';
    let tagsHTML = '<div style="color: #fff; text-align:center;">Geen Tags</div>';
    let convHTML = '<div style="color: #fff; text-align:center;">Geen Veroordelingen</div>';
    let incidentsHTML = '<div style="color: #fff; text-align:center;">Geen Processen-Verbaal</div>';
    let vehHTML = '<div style="color: #fff; text-align:center;">Geen Voertuigen</div>';
    let galleryHTML = '<div style="color: #fff; text-align:center;">Geen afbeeldingen</div>';
    let propertyHTML = '<div style="color: #fff; text-align:center;">Geen onroerend goed</div>';
      ...
      if (canSaveProfile == true) {
        ...
        setTimeout(() => {
          if (canRefreshIncidents == true) {
            ...
            setTimeout(() => {
              $(".incidents-search-refresh").empty();
              $(".incidents-search-refresh").html("Vernieuw");
  ...
  $(".manage-incidents-title-holder").on(
    ...
    function () {
      ...
      <div style="color: white;">
          ...
          <p><em>[Noteer_de_feiten_in_chronologische_volgorde_en_de_verklaring_van_de_verdachte]</em></p>
          <p>&nbsp;</p>
          <p><strong>🧍 Gijzelaar:</strong> [Naam_en_getuigenis]</p>
          <p>&nbsp;</p>
          <p><strong>🗄️ Bewijskast nummer: Noteer_hier_het_PV_nummer</strong> </p>
          <p>&nbsp;</p>
          <p><strong>🔪 In beslag genomen goederen</strong></p>
          <p><em>· [Oplijsten_onder_elkaar]</em></p>
          <p>&nbsp;</p>
          <p>-----</p>
          <p><strong style="background-color: var(--color-1);">💸 Boete:</strong></p>
          <p>&nbsp;</p>
          <p><strong>⌚ Celstraf:</strong></p>
          <p>-----</p>
      </div>
  `;
      $("#manage-incidents-title-input").val(
        "Naam - Misdrijf - " + $(".date").html()
      );
    ...
    $(".manage-incidents-reports-content").trumbowyg('html', template);
      ...
      $(".manage-incidents-title-holder").prepend(
        `
            <div class="manage-incidents-title">Proces-Verbaal</div>
      ...
      $(".manage-incidents-editing-title").html(
        "Je bent een nieuw Proces-Verbaal aan het maken"
      );
  ...
  $(".manage-bolos-title-holder").on(
    ...
    function () {
      ...
      if ($(".badge-logo").attr("src") == "img/ems_badge.webp") {
        template = `
        <div style="color: white;">
            <p><strong>📝 ------ TE BESPREKEN MET HOOFD AMBULANCE WAT HIER MOET KOMEN ------ ICU Room #: [ # ]</strong></p>
    ...
    `;
      ...
      $(".manage-bolos-editing-title").html(
        "Je bent een nieuw dossier aan het maken"
      );
  ...
  $(".bolos-search-refresh").click(function () {
    if (canRefreshBolo == true) {
      ...
      setTimeout(() => {
        $(".bolos-search-refresh").empty();
        $(".bolos-search-refresh").html("Vernieuw");
        canRefreshBolo = true;
          ...
          `
            <div class="associated-incidents-user-container" data-id="${$(this).data("cid")}">
                ...
                <div class="associated-incidents-user-tags-holder">
                    <div class="associated-incidents-user-tag red-tag" data-id="${$(this).data("cid")}">Aanhoudingsbevel</div>
                    <div class="associated-incidents-user-tag red-tag" data-id="${$(this).data("cid")}">Schuldig</div>
                ...
                <div class="manage-incidents-title-tag" data-id="${$(this).data("cid")}">Aanbevolen Boete</div>
                ...
                <div class="manage-incidents-title-tag" data-id="${$(this).data("cid")}">Aanbevolen Celstraf</div>
                ...
                <div class="associated-incidents-fine-input" data-id="${$(this).data("cid")}"><img src="img/h7S5f9J.webp"> <input placeholder="Voeg boete in ..." value="0" class="fine-amount" data-id="${$(this).data("cid")}" type="number"></div>
                <div class="manage-incidents-title-tag" data-id="${$(this).data("cid")}">Sentence</div>
                <div class="associated-incidents-sentence-input" data-id="${$(this).data("cid")}"><img src="img/9Xn6xXK.webp"> <input placeholder="Voeg Celstraf in ..." value="0" class="sentence-amount" data-id="${$(this).data("cid")}" type="number"></div>
  ...
  $(".reports-search-refresh").click(function () {
    if (canRefreshReports == true) {
      ...
      setTimeout(() => {
        $(".reports-search-refresh").empty();
        $(".reports-search-refresh").html("Vernieuw");
  ...
  $(".dispatch-comms-refresh").click(function () {
    ...
    setTimeout(() => {
      $(".dispatch-comms-refresh").empty();
      $(".dispatch-comms-refresh").html("Vernieuw");
      canRefreshReports = true;
...
`;}
      $(".manage-reports-editing-title").html(
        "Je bent een nieuw Verslag aan het maken"
      );
                            ...
                            <div style="display: flex; flex-direction: column;">
                                <div class="dmv-item-title">${value.model}</div>
                                    <div class="dmv-tags">
                                        ...
                                        <div class="dmv-tag ${bolo}">Gezocht</div>
                                        <div class="dmv-tag ${stolen}">Gestolen</div>
                                        <div class="dmv-tag ${codefive}">Gevaarlijk</div>
                                    </div>
                                </div>
        ...
        args = [
          {
            ...
            icon: "fas fa-times",
            text: "Verwijder gevaarlijk status",
            info: plate,
            status: "",
          },
        ];
        ...
        args = [
          {
            ...
            icon: "fas fa-times",
            text: "Verwijder gestolen status",
            info: plate,
            status: "",
          },
        ];
  ...
  $(".warrants-items").on("contextmenu", ".warrants-item", function (e) {
    ...
    args = [
      ...
      },
      {
        ...
        icon: "fas fa-search",
        text: `Bekijk PV nr. ${$(this).data("id")}`,
        info: $(this).data("id"),
        status: "",
      },
    ];
  ...
  function JobColors(sentJob) {
    if (sentJob) {
      if (PoliceJobs[sentJob] !== undefined)  {
        ...
        $(".bolo-nav-item").html("Recherche");
        $(".bolos-search-title").html("Onderzoeksdossiers");
        $("#bolos-search-input").attr("placeholder", "Zoek dossier...");
        $(".manage-bolos-title").html("Dossier Beheren");
        $(".manage-bolos-editing-title").html(
          "Druk op NIEUW om een nieuw onderzoek te starten"
        );
        $(".boloplate-title").html("Voornaamste feiten");
        $(".boloowner-title").html("Bende");
        $(".boloindividual-title").html("Andere verdachten");
        $("#boloplate").attr("placeholder", "Noteer hier de voornaamste feiten ...");
        $("#bolodetail").attr(
          "placeholder",
          "Nuttige informatie."
        );
        $("#boloowner").attr(
          "placeholder",
          "Noteer hier of het gaat om georganiseerde misdaad ..."
        );
        $("#boloindividual").attr(
          "placeholder",
          "Noteer persoon ..."
        ...
        $(".manage-bolos-title").html("Beheer ICU Check-in");
        $(".manage-bolos-editing-title").html(
          "Druk op NIEUW om een nieuwe Check-in te maken"
        );
        $(".boloplate-title").html("Geschatte revalidatietijd");
        $(".boloowner-title").html("Contact in geval van nood");
        $(".boloindividual-title").html("Voornaamste klacht");
        $("#boloplate").attr(
          "placeholder",
          "Hoelang verwacht je dat de patient door zal brengen in het ziekenhuis ..."
        );
        $("#bolodetail").attr(
          "placeholder",
          "Nuttige informatie ..."
        ...
        $("#boloowner").attr(
          "placeholder",
          "Noteer hier naam en telefoonnummer van de contactpersoon..."
        );
        $("#boloindividual").attr(
          "placeholder",
          "De hoofdreden voor opname in het ziekenhuis..."
        );
        $(".incidents-nav-item").hide();
        $(".dmv-nav-item").hide();
        $(".cams-nav-item").hide();
        $("#reports-officers-involved-tag-title").html(
          "Betrokken Medisch personeel"
        );
        $("#bolos-officers-involved-tag-title").html(
          "Betrokken Medisch personeel"
        );
...
window.addEventListener("message", function (event) {
    ...
    if (eventData.type == "show") {
     ...
     /*  let fireCount = 0; */
      ...
      $.each(eventData.data, function (index, value) {
        $('.warrants-items').prepend(`<div class="warrants-item" data-cid=${value.cid} data-id=${value.linkedincident}><div style="display: flex; flex-direction: column; margin-top: 2.5px; margin-left: 0.75vh; width: 100%;">
            ...
            <div class="warrant-bottom-info">
                <div class="warrant-id">PV nummer: ${value.linkedincident}</div>
            </div>
        </div></div>`)
    })
        ...
        $(".incidents-items").append(
          `<div class="incidents-item" data-id="${value.id}">
                    <div class="incidents-top-holder">
                        ...
                        <div class="incedent-report-name">Proces-Verbaal</div>
                    </div>
                    <div class="incidents-bottom-holder">
                        <div class="incedent-report-id">PV nr.  ${value.id}</div>
      ...
      $(".manage-incidents-editing-title").html(
        "Je bent proces-verbaal nummer " + table["id"] + " aan het bewerken"
      );
      ...
      $.each(associateddata, function (index, value) {
        ...
        const associatedIncidentsContainer = (value.associated != 1) && `
          ...
          <div class="manage-incidents-title-tag" data-id="${cid}">Aanbevolen Boete</div>
          ...
          <div class="manage-incidents-title-tag" data-id="${cid}">Aanbevolen Celstraf</div>
          ...
          <div class="manage-incidents-title-tag" data-id="${cid}">Boete</div>
          <div class="associated-incidents-fine-input" data-id="${cid}"><img src="img/h7S5f9J.webp"> <input placeholder="Voer boete in..." value="0" class="fine-amount" data-id="${cid}" type="number"></div>
          <div class="manage-incidents-title-tag" data-id="${cid}">Celstraf</div>
          <div class="associated-incidents-sentence-input" data-id="${cid}"><img src="img/9Xn6xXK.webp"> <input placeholder="Voer celstraf..." value="0" class="sentence-amount" data-id="${cid}" type="number"></div>
        ...
        $(".incidents-ghost-holder").prepend(
          `<div class="associated-incidents-user-container" data-id="${cid}">
              ...
              <div class="associated-incidents-user-tags-holder">
                  <div class="associated-incidents-user-tag ${warrantTag}" data-id="${cid}">Aanhoudingsbevel</div>
                  <div class="associated-incidents-user-tag ${guiltyTag}" data-id="${cid}">Schuldig</div>
      ...
      let table = eventData.data;
      $(".manage-bolos-editing-title").html(
        "Je bent dossier nummer " + table["id"] + " aan het bewerken"
      );

      if ($(".badge-logo").attr("src") == "img/ems_badge.webp") {
        $(".manage-bolos-editing-title").html(
          "Je bent Check-In nummer " + table["id"] + " aan het bewerken"
        );
      }
      ...
      let table = eventData.data;
      var reportName = "Onderzoeksdossier";
      canSearchForProfiles = true;
      $(".bolos-items").empty();
      if ($(".badge-logo").attr("src") == "img/ems_badge.webp") {
        ...
        $(".bolos-items").prepend(
          `<div class="bolo-item" data-id="${value.id}">
                    ...
                    <div class="bolo-bottom-holder">
                        <div class="bolo-report-id">Dossier nr.  ${value.id}</div>
      ...
      $(".manage-bolos-editing-title").html(
        "Je bewerkt momenteel Dossier nummer " + id
      );
        ...
        $(".reports-items").append(
          `<div class="reports-item" data-id="${value.id}">
                    ...
                    <div class="reports-bottom-holder">
                        <div class="reports-report-id">Verslag nr.  ${value.id}</div>
      ...
      $(".manage-reports-editing-title").html(
        "Je bent Verslag nummer " + table["id"] + " aan het bewerken"
      );
      ...
      $(".vehicle-tags").append(`<div class="vehicle-tag ${bolo}">Gezocht</div>`);
      $(".vehicle-tags").append(`<div class="vehicle-tag ${codefive} code5-tag">Gevaarlijk</div>`);
      $(".vehicle-tags").append(`<div class="vehicle-tag ${stolen} stolen-tag">Gestolen</div>`);
      $(".vehicle-info-imageurl-input").val(table["image"]);
    ...
    <div class="profile-item" data-id="${value.citizenid}" data-fingerprint="${value.fingerprint}">
        ...
        <div style="display: flex; flex-direction: column;">
            ...
            <div class="profile-criminal-tags">
                <span class="license-tag ${warrant}">${value.warrant ? "Actief" : "Geen"} Aanhoudingsbevel</span>
                <span class="license-tag ${convictions}">${value.convictions} Veroordelingen </span>
            </div>
        </div>
        <div class="profile-bottom-info">
            <div class="profile-id"><span class="fas fa-id-card"></span> Burger ID: ${value.citizenid}</div>&nbsp;
        </div>
        </div>
    </div>
`;
