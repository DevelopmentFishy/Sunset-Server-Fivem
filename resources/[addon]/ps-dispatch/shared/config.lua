...
Config.DefaultAlertsDelay = 1 -- Delay between each default alert, prevent spamming
...
Config.Locations = {
    ...
    ["NoDispatchZones"] = {
        [1] = {label = "lasershooting", coords = vector3(758.03, -60.65, 2.09), length = 75.0, width = 75.0, heading = 0, minZ = -40.91, maxZ = -0.31},
