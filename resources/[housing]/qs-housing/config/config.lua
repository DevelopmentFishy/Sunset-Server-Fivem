...
Config.Taxes = { AgencyFee = 0, BankFee = 0, TaxesFee = 0 }
...
Config.TimeAutoCloseDoor = 10            -- In minutes
...
Config.PlantsLimit = 25                         -- Limit plants
Config.HarvestTime = 4                         -- Setting it by hours (1 = 60 minutes)
Config.PoliceFirePlants = true                 -- Police can fire plants?
Config.HarvestItem = 'empty_weed_bag'          -- Require item for harvestItem
Config.HarvestAmountWeed = math.random(5, 10) -- Amount of weed that will give you
Config.HarversAmountSeeds = {                  -- Quantity of seeds that dates you depending on the gender
    male = math.random(1, 2),
    female = math.random(1, 2),
}
