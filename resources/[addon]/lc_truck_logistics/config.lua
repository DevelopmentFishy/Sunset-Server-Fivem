...
Config.trucker_locations = {
	["trucker_1"] = {															-- ID
		...
		['blips'] = {							-- Create the blips on map
			...
			['name'] = "The Truck Company",		-- Blip Name
			['color'] = 3,						-- Blip Color
...
Config.jobs = {
	...
	['available_loads'] = {
		...
		{ trailer = "armytanker", name = "Army secret materials", def = {0,1,1}},

		{ trailer = "liquide1", name = "Potassium hydroxide", def = {5,0,0}},
		...
		{ trailer = "docktrailer", name = "Furniture transport", def = {0,1,0}},
		{ trailer = "docktrailer", name = "Refrigerator transport", def = {0,0,0}},
		{ trailer = "docktrailer", name = "Brick transport", def = {0,0,0}},
		{ trailer = "docktrailer", name = "Transport of imported products", def = {0,1,1}},
		...
		{ trailer = "trailers", name = "Transport of vaccines", def = {5,0,0}},
		{ trailer = "trailers", name = "Transport of explosives", def = {1,0,0}},
		...
		{ trailer = "heli1", name = "helicopter transport", def = {0,0,1}},
		{ trailer = "heli1", name = "helicopter transport", def = {0,0,1}},
		{ trailer = "heli1", name = "helicopter transport", def = {0,0,1}},
		{ trailer = "heli1", name = "helicopter transport", def = {0,0,1}},
		{ trailer = "heli1", name = "helicopter transport", def = {0,0,1}},
...
Config.drivers = {
	...
	['hiring_costs'] = {						-- Cost of hiring the driver (this amount will only be paid at the time of hiring)
		...
		['percentage_skills'] = 10,				-- This is the % cost that each skill will add to the cost of hiring the driver. That is, for each skill level the driver has, this percentage will increase. (In this case, each skill will increase the cost by 25%)
	},
...
Config.driver_jobs = {
	...
	['profit'] = {								-- These are the drivers' earnings for each contract, a random value is generated for each contract
		['min'] = 500,							-- Minimum base profit, this will be the minimum money this driver can generate
		['max'] = 550,							-- Maximum base profit, this will be the maximum amount of money this driver can generate (this amount will increase according to the driver's skills)
		['percentage_skills'] = 5,				-- This is the % value that each skill will add to the driver's final profit. That is, the more skills he has, the greater the profit.
	},
...
Config.dealership = {							-- Truck dealership vehicles
	...
	['scania1'] = { 								-- Vehicle spawn name
		['name'] = 'Scania kleinjan',		-- Truck name
		['price'] = 500000,						-- Value
		['engine'] = "15.0 Cummins ISX I6",	-- Engine configuration
		['transmission'] = "12-Speed",			-- Transmission configuration
		['hp'] = '450',							-- Horsepower
		['img'] = 'https://cdn.discordapp.com/attachments/1174103534027943956/1208218443946664007/scania1.png?ex=65e27c1c&is=65d0071c&hm=47648e4ec3476b83c0c0ac68e4864695f73a241b88a9ce625cb33f59f874657d&',				-- Vehicle image
		['driver_bonus'] = 10 					-- This percentage represents the additional earnings a driver receives when using this specific truck
	},
	...
	['scania2'] = {
		...
		['hp'] = '450',
		['img'] = 'https://cdn.discordapp.com/attachments/1174103534027943956/1208219102037147648/scania2.png?ex=65e27cb9&is=65d007b9&hm=4372494b2d36f727a4d357de86fc1b7040b6491ef5ce7745fa9f3494e195514d&',
		['driver_bonus'] = 10
	},
	['scania3'] = {
		['name'] = 'Scania Truck Company',
		['price'] = 500000,
		['engine'] = "15.0 Cummins ISX I6",
		['transmission'] = "12-Speed",
		['hp'] = '450',
		['img'] = 'https://cdn.discordapp.com/attachments/1174103534027943956/1208219709665706077/scania3.png?ex=65e27d4a&is=65d0084a&hm=24078b1f8109e80b05d8cc08f1fa833c2a5ba40de3680bf429ea609a267cede0&',
		['driver_bonus'] = 10
	}
}
...
Config.party = {
	...
	['max_members'] = 20,			-- Maximum number of members of each group
	['party_money_bonus'] = 1,		-- Bonus money (in %) that each party member receives upon completing a delivery
	['party_exp_bonus'] = 1,		-- Bonus xp (in %) that each party member receives when completing a delivery
