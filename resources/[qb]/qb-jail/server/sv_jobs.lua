...
lib.callback.register('qb-jail:server:GetGroupData', function(source)
    local retval = {
        [1] = { job = 'gardening',  amount = #jobGroups.gardening,  label = Locales['gardening'] },
        [2] = { job = 'running',    amount = #jobGroups.running,    label = Locales['running'] },
        [3] = { job = 'scrapyard',  amount = #jobGroups.scrapyard,  label = Locales['scrapyard'] },
        [4] = { job = 'cleaning',   amount = #jobGroups.cleaning,   label = Locales['cleaning'] },
        [5] = { job = 'workout',    amount = #jobGroups.workout,    label = Locales['workout'] },
        [6] = { job = 'kitchen',    amount = #jobGroups.kitchen,    label = Locales['kitchen'] },
        [7] = { job = 'electrical', amount = #jobGroups.electrical, label = Locales['electrical'] },
        [8] = { job = 'lockup',     amount = #jobGroups.lockup,     label = Locales['lockup'] }
    }
...
skateParkSetup = {
    [1] = { model = `prop_skate_quartpipe`, coords = vector3(1642.85, 2621.0, 45.9),    heading = 0.0 },
    [2] = { model = `prop_skate_halfpipe`,  coords = vector3(1628.16, 2632.34, 44.56),  heading = 90.0 },
    [3] = { model = `prop_skate_quartpipe`, coords = vector3(1642.85, 2590.16, 45.9),   heading = 180.0 },
    [4] = { model = `prop_skate_flatramp`,  coords = vector3(1640.90, 2608.73, 44.56),  heading = 180.0 },
    [5] = { model = `prop_skate_kickers`,   coords = vector3(1640.90, 2603.87, 44.56),  heading = 0.0 },
    [6] = { model = `prop_skate_quartpipe`, coords = vector3(1657.85, 2621.0, 45.9),    heading = 0.0 },
    [7] = { model = `prop_skate_quartpipe`, coords = vector3(1657.85, 2590.66, 45.9),   heading = 180.0 },
    [8] = { model = `prop_skate_spiner`,    coords = vector3(1657.85, 2606.21, 44.56),  heading = 180.0 },
    [9] = { model = `prop_skate_funbox`,    coords = vector3(1649.61, 2605.36, 44.56),  heading = 180.0 }
}
...
RegisterNetEvent('qb-jail:server:FinishKitchenTask', function(task, success)
    ...
    if task ~= currentKitchenTask then
        Utils.Notify(src, Locales['notify_wrong_task'], 'error', 2500)
        return
    end
    ...
    if kitchenTasks[task].current >= kitchenTasks[task].max then 
        ...
        for k, v in pairs(getGroupMembers('kitchen')) do
            TriggerClientEvent('qb-jail:client:ProgressUpdate', v, (Locales['textui_kitchencurrent']):format(kitchenTasks[currentKitchenTask].label))
        end
    else
        ...
        for k, v in pairs(getGroupMembers('kitchen')) do
            TriggerClientEvent('qb-jail:client:ProgressUpdate', v, (Locales['textui_kitchenprogress']):format(kitchenTasks[currentKitchenTask].label, progress))
        end
    end
    ...
    if success and kitchenTasks[task].chance and kitchenTasks[task].chance >= math.random(100) then
        ...
        if Config.Inventory == 'ox_inventory' then
            exports['ox_inventory']:AddItem(src, item, Config.KitchenRewardAmount)
...
lib.callback.register('qb-jail:server:GetCurrentKitchenTask', function(source)
    if not isJobGroupMember(source, 'kitchen') then return nil, nil end

    local progress = math.floor(100 * kitchenTasks[currentKitchenTask].current / kitchenTasks[currentKitchenTask].max)
    return kitchenTasks[currentKitchenTask].label, progress
end)
...
cleaningActives = nil
cleaningSetup = {
    [1] = { model = `prop_big_shit_01`, coords = vector3(1767.826, 2502.826, 45.0), handle = 0, active = false },
    [2] = { model = `prop_big_shit_02`, coords = vector3(1767.58, 2501.183, 44.74), handle = 0, active = false },
    [3] = { model = `ng_proc_litter_plasbot2`, coords = vector3(1768.65, 2490.387, 45.56), handle = 0, active = false },
    [4] = { model = `ng_proc_litter_plasbot3`, coords = vector3(1763.913, 2483.16, 44.74), handle = 0, active = false },
    [5] = { model = `prop_big_shit_02`, coords = vector3(1764.34, 2499.057, 44.74), handle = 0, active = false },
    [6] = { model = `prop_big_shit_01`, coords = vector3(1761.585, 2499.193, 45.0), handle = 0, active = false },
    [7] = { model = `prop_big_shit_01`, coords = vector3(1752.115, 2493.738, 45.0), handle = 0, active = false },
    [8] = { model = `ng_proc_litter_plasbot2`, coords = vector3(1749.706, 2492.559, 44.74), handle = 0, active = false },
    [9] = { model = `prop_big_shit_02`, coords = vector3(1748.582, 2490.014, 44.74), handle = 0, active = false },
    [10] = { model = `prop_big_shit_01`, coords = vector3(1758.009, 2470.543, 45.0), handle = 0, active = false },
    [11] = { model = `prop_big_shit_01`, coords = vector3(1761.177, 2472.377, 45.0), handle = 0, active = false },
    [12] = { model = `prop_big_shit_01`, coords = vector3(1764.304, 2474.206, 45.0), handle = 0, active = false },
    [12] = { model = `prop_big_shit_01`, coords = vector3(1767.447, 2476.022, 45.0), handle = 0, active = false },
    [13] = { model = `prop_big_shit_02`, coords = vector3(1771.150, 2479.514, 44.74), handle = 0, active = false },
    [14] = { model = `prop_big_shit_01`, coords = vector3(1773.699, 2479.665, 45.0), handle = 0, active = false },
    [15] = { model = `prop_big_shit_01`, coords = vector3(1776.896, 2481.472, 45.0), handle = 0, active = false },
    [16] = { model = `ng_proc_litter_plasbot2`, coords = vector3(1775.387, 2484.792, 44.74), handle = 0, active = false },
    [17] = { model = `ng_proc_cigpak01c`, coords = vector3(1759.069, 2484.628, 45.56), handle = 0, active = false },
    [18] = { model = `ng_proc_cigpak01c`, coords = vector3(1765.612, 2501.742, 48.69), handle = 0, active = false },
    [19] = { model = `prop_big_shit_01`, coords = vector3(1767.871, 2502.861, 49.00), handle = 0, active = false },
    [20] = { model = `prop_big_shit_02`, coords = vector3(1762.477, 2500.059, 48.69), handle = 0, active = false },
    [21] = { model = `prop_big_shit_01`, coords = vector3(1761.552, 2499.216, 49.0), handle = 0, active = false },
    [22] = { model = `prop_big_shit_01`, coords = vector3(1758.40, 2497.418, 49.0), handle = 0, active = false },
    [23] = { model = `prop_big_shit_01`, coords = vector3(1755.25, 2495.568, 49.0), handle = 0, active = false },
    [24] = { model = `prop_big_shit_02`, coords = vector3(1751.83, 2491.953, 48.69), handle = 0, active = false },
    [25] = { model = `prop_big_shit_01`, coords = vector3(1748.95, 2491.959, 49.0), handle = 0, active = false },
    [26] = { model = `prop_big_shit_01`, coords = vector3(1758.00, 2470.617, 49.0), handle = 0, active = false },
    [27] = { model = `prop_big_shit_01`, coords = vector3(1761.17, 2472.427, 49.0), handle = 0, active = false },
    [28] = { model = `prop_big_shit_02`, coords = vector3(1763.75, 2476.044, 48.69), handle = 0, active = false },
    [29] = { model = `prop_big_shit_01`, coords = vector3(1767.44, 2476.01, 49.00), handle = 0, active = false },
    [30] = { model = `prop_big_shit_01`, coords = vector3(1770.60, 2477.81, 49.00), handle = 0, active = false },
    [31] = { model = `ng_proc_litter_plasbot2`, coords = vector3(1771.93, 2478.40, 48.69), handle = 0, active = false },
    [32] = { model = `prop_big_shit_01`, coords = vector3(1773.76, 2479.68, 49.00), handle = 0, active = false },
    [33] = { model = `prop_big_shit_01`, coords = vector3(1776.85, 2481.50, 49.00), handle = 0, active = false }
}
...
RegisterNetEvent('qb-jail:server:FinishCleaningTask', function(netId, success)
    ...
    if cleaningActives <= 0 then
        ...
        for k, v in pairs(getGroupMembers('cleaning')) do
            TriggerClientEvent('qb-jail:client:ProgressUpdate', v, (Locales['textui_cleaningprogress']):format(progress))
        end
    end
end)

lib.callback.register('qb-jail:server:GetActiveCleaningTasks', function(source)
    local temp = {}
...
scrapYardObjects = {}
scrapYardSetup = {
    [1] = { model = `prop_pile_dirt_03`, coords = vector3(1658.67, 2519.24, 44.56), heading = 90.00, rewards = {'metalscrap', 'steel', 'iron', 'copper', 'prisonrock'} },
    [2] = { model = `prop_rub_pile_01`, coords = vector3(1649.94, 2511.99, 44.56), heading = 90.00, rewards = {'rubber'} },
    [3] = { model = `prop_pile_dirt_02`, coords = vector3(1656.75, 2509.28, 44.56), heading = 90.00, rewards = {'rubber'} }
}
...
RegisterNetEvent('qb-jail:server:PrisonScrap', function(index, success)
    ...
    if success and Config.ScrapRewardChance >= math.random(100) then
        ...
        if Config.Inventory == 'ox_inventory' then
            exports['ox_inventory']:AddItem(src, item, Config.ScrapRewardAmount)
        elseif Config.Inventory == 'qb' then
...
lib.callback.register('qb-jail:server:GetActiveElectricalTasks', function(source)
    local temp = {}
...
RegisterNetEvent('qb-jail:server:PlantSeed', function(index)
    ...
    if Config.Inventory == 'ox_inventory' and exports['ox_inventory']:RemoveItem(src, 'prisonfarmseeds', 1) then
        farmingSetup[index].planted = true
        farmingSetup[index].health = 100

        Utils.Notify(src, Locales['notify_gardening_seeds'], 'success', 2500)
    elseif Config.Inventory == 'qb' and Player.Functions.RemoveItem('prisonfarmseeds', 1) then
        farmingSetup[index].planted = true
        farmingSetup[index].health = 100
...
RegisterNetEvent('qb-jail:server:HarvestPlant', function(index)
    ...
    if Config.Inventory == 'ox_inventory' then
        exports['ox_inventory']:AddItem(src, 'prisonfruit', Config.FarmingHarvestAmount)
        Utils.Notify(src, Locales['notify_gardening_harvest'], 'success', 2500)
    elseif Config.Inventory == 'qb' then
...
RegisterNetEvent('qb-jail:server:GiveWater', function(index)
    ...
    if Config.Inventory == 'ox_inventory' and exports['ox_inventory']:GetSlotWithItem(src, 'prisonwateringcan') then
        ...
        Utils.Notify(src, Locales['notify_gardening_water'], 'success', 2500)
    elseif Config.Inventory == 'qb' and Player.Functions.GetItemByName('prisonwateringcan') then
        farmingSetup[index].water += 70
...
RegisterNetEvent('qb-jail:server:GiveFertilizer', function(index)
    ...
    if Config.Inventory == 'ox_inventory' and exports['ox_inventory']:RemoveItem(src, 'prisonfarmnutrition', 1) then
        ...
        Utils.Notify(src, Locales['notify_gardening_fertilizer'], 'success', 2500)
    elseif Config.Inventory == 'qb' and Player.Functions.RemoveItem('prisonfarmnutrition', 1) then
        farmingSetup[index].fertilizer += 70
...
lib.callback.register('qb-jail:server:GetFarmingStatus', function(source, index)
    if not isJobGroupMember(source, 'gardening') or not farmingSetup[index] then return nil end
