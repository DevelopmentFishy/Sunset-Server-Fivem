local Translations = {
    ...
    info = {
        ...
        drug_offer = "[E] %{bags}x %{drugLabel} voor €%{randomPrice}? / [G] Weiger aanbod",
        pick_up_button = "[E] Oppakken",
        knock_button = "[E] Aankloppen",
        mystery_man_button = "[E] Kopen / [G] Help je vriend ($5000)",
        other_dealers_button = "[E] Kopen / [G] Start een missie",
        ...
        deliver_items_button = "[E] %{itemAmount}x %{itemLabel} leveren",
