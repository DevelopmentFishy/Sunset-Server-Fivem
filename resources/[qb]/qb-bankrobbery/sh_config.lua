...
Config.SmallBanks = {
    [1] = {
        ["label"] = "Hawick Avenue",
        ["coords"] = vector3(311.17, -284.42, 54.16),
        ["alarm"] = true,
        ...
        ["lockers"] = {
            [1] = {
                ["coords"] = vector3(314.09, -283.27, 54.16),
                ["isBusy"] = false,
                ["isOpened"] = false
            },
            [2] = {
                ["coords"] = vector3(315.52, -285.03, 54.16),
                ["isBusy"] = false,
                ["isOpened"] = false
            },
            [3] = {
                ["coords"] = vector3(311.39, -286.23, 54.16),
                ["isBusy"] = false,
                ["isOpened"] = false
            },
            [4] = {
                ["coords"] = vector3(310.88, -287.68, 54.16),
                ["isBusy"] = false,
                ["isOpened"] = false
            },
            [5] = {
                ["coords"] = vector3(311.54, -288.71, 54.16),
                ["isBusy"] = false,
                ["isOpened"] = false
            },
            [6] = {
                ["coords"] = vector3(313.46, -289.39, 54.16),
                ["isBusy"] = false,
                ["isOpened"] = false
            },
            [7] = {
                ["coords"] = vector3(314.7, -288.92, 54.16),
                ["isBusy"] = false,
                ["isOpened"] = false
            },
            [8] = {
                ["coords"] = vector3(315.14, -287.44, 54.16),
                ["isBusy"] = false,
                ["isOpened"] = false
            }
        }
