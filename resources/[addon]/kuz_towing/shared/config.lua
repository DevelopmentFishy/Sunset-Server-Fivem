...
Locale.press_to_attach = 'Druk om te bevestigen'
Locale.press_to_detach = 'Verwijder alle touwen'
Locale.vehicles_locked = 'Deze wagen is op slot en kan niet worden getakeld'
