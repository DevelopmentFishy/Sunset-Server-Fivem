...
Config.StealWithoutWeapons = true       -- Possibility to draw only if the target player raises his arms (without weapons)
...
Config.ItemDropObject = `p_poly_bag_01_s` -- or false
