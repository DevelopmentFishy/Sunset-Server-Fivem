...
Config.Locations[#Config.Locations+1] = { --[[ GABZ ALTA STREET BENNYS ]]--
	...
	stash = {
		{ coords = vec4(0, 0, 0, 0), w = 3.6, d = 0.8, },
	},
	store = {
		{ coords = vec4(0, 0, 0, 0), w = 3.60, d = 0.8 },
	},
	crafting = {
		{ coords = vec4(0, 0, 0, 0), w = 2.8, d = 1.5 },
	},
	clockin = {
		{ coords = vec4(0, 0, 0, 0), prop = false },
	},
	manualRepair = {
		{ coords = vec4(-205.49, -1326.93, 30.89, 358), prop = true, },

	},
	carLift = {
        { coords = vec4(0, 0, 0, 0), use = true },
        { coords = vec4(0, 0, 0, 0), use = true },
    },
	garage = {
		spawn = vec4(0, 0, 0, 0),
...
Config.Locations[#Config.Locations+1] = { --[[ LS CUSTOMS IN CITY ]]--
	...
	job = "mechanic",
	zones = {
		vec2(-398.53298950196, -66.62654876709),
  		vec2(-416.68670654296, -84.537773132324),
  		vec2(-360.13940429688, -183.3804473877),
  		vec2(-304.45867919922, -164.7830505371),
  		vec2(-296.39163208008, -114.14541625976)
	},
	autoClock = { enter = false, exit = false, },
	stash = {
		{ coords = vec4(0, 0, 0, 0), w = 3.6, d = 2.0, },
	},
	store = {
		{ coords = vec4(0, 0, 0, 0), w = 0.4, d = 1, },
	},
	crafting = {
		{ coords = vec4(0, 0, 0, 0), w = 6.2, d = 2.0, },
	},
	clockin = {
		{ coords = vec4(0, 0, 0, 0), w = 0.6, d = 1.0, },
	},
	manualRepair = {
		{ coords = vec4(-335.91, -140.57, 39.01, 71.88), prop = true, },
	},
	garage = {
		spawn = vec4(0, 0, 0, 0),
		out = vec4(0, 0, 0, 0),
	...
	payments = {
		...
		{ coords = vec4(0, 0, 0, 0), w = 0.4, d = 1.0, },
	},
	Restrictions = {
		Vehicle = { "Compacts", "Sedans", "SUVs", "Coupes", "Muscle", "Sports Classics", "Sports", "Super", "Motorcycles", "Off-road", "Industrial", "Utility", "Vans", "Cycles", "Service", "Emergency", "Commercial", },
		Allow = { "tools", "cosmetics", "repairs", "perform" },
...
Config.Locations[#Config.Locations+1] = { --[[ Nieuwe mlo fastcustoms ]]--
	Enabled = true,
	job = "mechanic",
	zones = {
		vector2(-989.15899658204, -799.95471191406),
  		vector2(-963.36584472656, -816.77600097656),
  		vector2(-930.30145263672, -822.35266113282),
  		vector2(-869.17175292968, -821.36810302734),
  		vector2(-869.92376708984, -746.88464355468),
  		vector2(-977.83270263672, -748.12194824218)
	},
	autoClock = { enter = false, exit = false, },
	stash = {
		{ coords = vec4(-934.2, -773.19, 15.27, 0), w = 5.2, d = 2, },
	},
	store = {
		{ coords = vec4(-902.75, -758.28, 15.27, 90), w = 4.0, d = 1, },
		{ coords = vec4(-883.49, -789.24, 15.33, 270), w = 4.0, d = 1, },
	},
	crafting = {
		{ coords = vec4(-911.2, -758.24, 15.27, 90), w = 4.0, d = 1.0, },
		{ coords = vec4(-892.16, -789.23, 15.33, 90), w = 4.0, d = 1.0, },
		
	},
	clockin = {
		{ coords = vec4(-932.75, -779.81, 15.27, 23.0), w = 0.5, d = 0.5, },
	},
	manualRepair = {
		{ coords = vec4(0, 0, 0, 0), prop = true, },
	},
	...
	payments = {
		img = "https://static.wikia.nocookie.net/gtawiki/images/b/b6/Fastcustoms.png",
		{ coords = vec4(-932.74, -781.69, 15.27, 23.0), w = 0.5, d = 0.5, },
	},
	Restrictions = {
		Vehicle = { "Compacts", "Sedans", "SUVs", "Coupes", "Muscle", "Sports Classics", "Sports", "Super", "Motorcycles", "Off-road", "Industrial", "Utility", "Vans", "Cycles", "Service", "Emergency", "Commercial", },
	...
	blip = {
		coords = vec3(-918.76, -777.92, 15.27),
		label = "Fast Customs",
		color = 2,
		sprite = 446,
		disp = 6,
...
Config.Locations[#Config.Locations+1] = { -- [[LS CUSTOMS ROUTE 68]] --
	...
	autoClock = { enter = false, exit = false, },
	stash = {
		{ coords = vec4(0, 0, 0, 0), w = 1.6, d = 0.6 },
	},
	store = {
		{ coords = vec4(0, 0, 0, 0), w = 0.6, d = 0.5 },
	},
	crafting = {
		{ coords = vec4(0, 0, 0, 0), w = 3.2, d = 1.0 },
	},
	clockin = {
		{ coords = vec4(0, 0, 0, 0), prop = true, },
	},
	manualRepair = {
		{ coords = vec4(1175.2, 2636.44, 37.75, 357.76), prop = true, },
	},
	carLift = {
		{ coords = vec4(0, 0, 0, 0), },
		{ coords = vec4(0, 0, 0, 0) },
...
Config.Locations[#Config.Locations+1] = { --[[ BEEKERS GARAGE PALETO ]]--
	...
	manualRepair = {
		{ coords = vec4(108.53, 6628.81, 31.79, 227.15), prop = true, },
	},
	carLift = {
		{ coords = vec4(0, 0, 0, 0), },
	},
...
Config.Locations[#Config.Locations+1] = { --[[ AIRPORT LS CUSTOMS ]]--
	...
	crafting = {
		{ coords = vec4(0, 0, 0, 0), w = 0.6, d = 3.8, },
	},
	clockin = {
		{ coords = vec4(0, 0, 0, 0), prop = true, },
	},
	manualRepair = {
		{ coords = vec4(-1160.17, -2008.72, 13.18, 315.57), prop = true, },
	},
	carLift = {
		{ coords = vec4(0, 0, 0, 0) },
	},
...
Config.Locations[#Config.Locations+1] = { --[[ POPULAR STREET LS CUSTOMS ]]--
	...
	autoClock = { enter = false, exit = false, },
	stash = {
		{ coords = vec4(0, 0, 0, 0), w = 3.2, d = 0.6, },
	},
	store = {
		{ coords =  vec4(0, 0, 0, 0), w = 3.8, d = 0.6, },
	},
	crafting = {
		{ coords =  vec4(0, 0, 0, 0), w = 0.8, d = 1.0, },
	},
	clockin = {
		{ coords =  vec4(0, 0, 0, 0), prop = true, },
	},
	manualRepair = {
		{ coords = vec4(735.62, -1088.86, 22.17, 91.0), prop = true, },
	},
	carLift = {
		{ coords = vec4(0, 0, 0, 0) },
		{ coords =  vec4(0, 0, 0, 0)}
