...
-- --- @return nil
-- function OnHackDone(success, bank)
...
Config.FleecaTime = 30
Config.FleecaBlocks = 2
Config.FleecaRepeat = 1

-- Paleto Laptop Config
Config.PaletoTime = 60
Config.PaletoBlocks = 3
Config.PaletoRepeat = 1

-- Fleeca Laptop Config
Config.PacificTime = 60
Config.PacificBlocks = 4
Config.PacificRepeat = 1
