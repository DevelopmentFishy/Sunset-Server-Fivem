...
Config.LetPlayersChangeVisibilityOfRadioList = false     -- Let players to toggle visibility of the list
...
Config.RadioListChangeNameCommand = "radionaam"       -- Only works if Config.LetPlayersSetTheirOwnNameInRadio is set to true
...
Config.ModifyRadioChannelNameCommand = "channelnaam"    -- Changes the name of the radio channel **that the player is currently joined in** => this is a validation to prevent normal players from modifying the name of the restricted channels they don't have access to(such as police, & etc)
