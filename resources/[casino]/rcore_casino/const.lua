...
LuckyWheelRandomItems = {{
    inventoryName = "sandwich", -- item (inventory) name/key, case sensitive
    title = "sandwich", -- title for the Lucky Wheel reward message
    amount = {1, 10} -- amount (random between 1 to 10)
}, {
    inventoryName = "kurkakola", -- item (inventory) name/key, case sensitive
    title = "Cola", -- title for the Lucky Wheel reward message
    amount = 1 -- only 1
}}
...
RestrictedAreas = {{
    ...
    coords = vector3(922.51, 33.88, 81.12),
    radius = 4,
    safearea = vector3(922.51, 33.88, 81.12),
    type = 2 -- boss area
}, {
...
OfficeBossMarkerPosition = vector3(922.41, 33.72, 81.12)
