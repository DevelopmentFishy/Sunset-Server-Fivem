                    ...
                    if isLoggedIn and closestCityhall and closestDrivingSchool then
                        if inside then
                            if current.drivingschool then
                                ...
                                exports['jg-textui']:DrawText('[E] Neem rijlessen')
                            elseif current.cityhall then
                                inRangeCityhall = true
                                exports['jg-textui']:DrawText('[E] Open Gemeentehuis')
                            end
                        else
...
RegisterNUICallback('close', function(_, cb)
    ...
    if not Config.UseTarget and inRangeCityhall then exports['jg-textui']:DrawText('[E] Open Gemeentehuis') end -- Reopen interaction when you're still inside the zone
    cb('ok')
end)
