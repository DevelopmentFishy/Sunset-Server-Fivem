Config = {
	...
	ManualRepairs = { -- Player vehicle repair config
		...
		dutyMessage = "Er is een garagist in de stad!", -- This is the notification that pops up when a person tries to repair when a mechanic is on duty, choose what you want for it.
	...
	NOS = { -- NOS STUF
		...
		NitrousCoolDown = 20, 		-- 7 Seconds for nitrous cooldown, set to 0 to disable
...
--DuctTape Controllers
	DuctTape = {
		...
		MaxDuctEngine = 500.0, 		-- 450.0 is 45% health, this will be the max amount that it can be repaired to
