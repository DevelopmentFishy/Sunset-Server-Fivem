...
Config.RequiredJob = "bouwvakker"             -- Set to "none" if you dont want using jobs. If you are using target, you have to set "job" parameter inside every export in target.lua
...
Config.OnePercentWorth = 150            -- Means that 1% progress will reward players with $100
...
Config.Lang = {
    ...
    ["no_permission"] = "Alleen de partij-eigenaar kan dat doen!",
    ["keybind"] = 'Constructiebaan Markering Interactie',
    ["too_far"] = "Jouw partij is begonnen met werken, maar je bent te ver van het hoofdkwartier",
    ["kicked"] = "Je hebt %s uit de partij geschopt",
    ["alreadyWorking"] = "Voltooi eerst de vorige opdracht",
    ["quit"] = "Je hebt het team verlaten",
    ["wrongCar"] = "Dit is niet jouw bedrijfsvoertuig",
    ["CarNeeded"] = "Je hebt je bedrijfsvoertuig nodig om de klus te klaren.",
    ["nobodyNearby"] = "Er is niemand in de buurt",
    ["cantInvite"] = "Om meer mensen uit te nodigen, moet je eerst de klus afronden",
    ["inviteSent"] = "Uitnodiging verzonden!",
    ["spawnpointOccupied"] = "De spawnlocatie van de auto of mixertruck is bezet",
    ["pipesNotReady"] = "Voordat je het beton giet, moet je eerst de leidingen installeren",
    ["clickToPour"] = "INPUT_CONTEXT om beton te gieten",
    ["installPipe"] = "Installeer leiding",
    ["pickupBlock"] = "Pak blok op",
    ["tutorialAfterMixerPickup"] = "Je hebt zojuist de aangewezen betonmixer van je baas opgehaald. Rijd ermee naar de bouwplaats en giet dan het beton op de aangewezen plekken. De bouwplaats is gemarkeerd op de GPS",
    ["startingTutorial"] = "Welkom bij het werk van de bouwer. Op de bouwplaats wachten verschillende taken op je, van lassen tot het bouwen van muren, het maken van afvoeren of het storten van beton. Als je in een groep werkt, moet je nu opsplitsen. Eén persoon moet worden afgezet op het punt waar de betonmixer wordt opgehaald en vervolgens de betonmixer naar de bouwplaats vervoeren. Elke activiteit wordt uitgelegd wanneer je er voor het eerst mee in aanraking komt. Je hebt de locaties van de taken gemarkeerd op de kaart. Als je alleen werkt, moet je elke taak zelf voltooien. Als je in groepen werkt, beslis je hoe je wilt verdelen. Je hoeft niet alle taken te doen, je kunt stoppen wanneer je wilt, en je betaling hangt af van hoeveel % van de taken je doet. We wensen je veel succes!",
    ["installBlock"] = "Bouw een muur",
    ["tutorialWallBuilding"] = "Je staat naast het muurframe, je taak is om het te bouwen met betonblokken. De betonblokken liggen in de buurt van het frame en zijn gemarkeerd op de GPS. Loop naar de stapel met de blokken, pak er een op en monteer het dan aan de muur",
    ["tutorialAboutPipes"] = "Je staat naast een gat met uitzicht op rioolbuizen. Je taak is om de leidingen op de juiste plaatsen te installeren. Na het installeren van de leidingen moet je beton over het gat gieten met een betonmixer.",
    ["tutorialWelding"] = "Je staat naast de plek waar de baas je vertelde iets te lassen. De taak is heel eenvoudig en vereist geen verdere uitleg",
    ["startWelding"] = "Begin met lassen",
    ["workstationOccupied"] = "Deze werkplek is bezet",
    ["notFullJob"] = "Je moet 100% voortgang maken voordat je een klus beëindigt",
    ["notADriver"] = "Je moet een chauffeur van het voertuig zijn om de klus te beëindigen",
    ["partyIsFull"] = "Het is niet gelukt om een uitnodiging te sturen, je groep is vol",
    ["wrongReward1"] = "Het uitbetalingspercentage moet tussen 0 en 100 liggen",
    ["wrongReward2"] = "Het totale percentage van alle uitbetalingen overschreed 100%",
    ["cantLeaveLobby"] = "Je kunt de lobby niet verlaten terwijl je aan het werk bent. Beëindig eerst de klus.",
    
    -- Server
    
["isAlreadyHost"] = "Deze speler leidt al zijn team.",
["isBusy"] = "Deze speler maakt al deel uit van een ander team.",
["hasActiveInvite"] = "Deze speler heeft al een actieve uitnodiging van iemand anders.",
["HaveActiveInvite"] = "Je hebt al een actieve uitnodiging om deel te nemen aan het team.",
["InviteDeclined"] = "Je uitnodiging is geweigerd.",
["InviteAccepted"] = "Je uitnodiging is geaccepteerd!",
["error"] = "Er was een probleem bij het deelnemen aan een team. Probeer het later opnieuw.",
["kickedOut"] = "Je bent uit het team gezet!",
["reward"] = "Je hebt een beloning ontvangen van $",
["RequireOneFriend"] = "Deze klus vereist minstens één teamlid",
["penalty"] = "Je hebt een boete betaald van ",
["clientsPenalty"] = "De teamleider heeft de straf geaccepteerd. Jij hebt de betaling niet ontvangen",
["noMixerStatus"] = "Momenteel hebben we geen vrije betonmixer voor jou. Probeer het later opnieuw",
["dontHaveReqItem"] = "Jij of iemand uit je team heeft het vereiste item niet om te kunnen werken",
["notEverybodyHasRequiredJob"] = "Niet al je vrienden hebben de vereiste baan",
["someoneIsOnCooldown"] = "%s kan de klus nu niet starten (cooldown: %s)",
["hours"] = "uur",
["minutes"] = "minuten",
["seconds"] = "seconden",
["newBoss"] = "De vorige lobbybaas heeft de server verlaten. Jij bent nu de teamleider",
}
