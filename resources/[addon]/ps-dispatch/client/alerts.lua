...
local function koperdiefstal()
    local coords = GetEntityCoords(cache.ped)

    local dispatchData = {
        message = locale('koperdiefstal'),
        codeName = 'koperdiefstal',
        code = '10-90',
        icon = 'fas fa-truck-front',
        priority = 2,
        coords = coords,
...
exports('koperdiefstal', koperdiefstal)

local function ContainerRobbery()
    local coords = GetEntityCoords(cache.ped)

    local dispatchData = {
        message = locale('containerRobbery'),
...
exports('ContainerRobbery', ContainerRobbery)
