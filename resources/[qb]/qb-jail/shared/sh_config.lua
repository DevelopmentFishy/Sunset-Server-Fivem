...
Config.JailBreakCops        = 3     -- Amount of cops on duty required to start a jailbreak
...
Config.FarmingLoopInterval  = 1     -- Minutes for the farming loop to increase growth and health based on water and nutrition
...
Config.ReduceReward = { -- %Chance to reduce the jail sentence after completing a task; Amount of minutes to reduce the jail time with
    gardening   = { chance = 50,    amount = 5 },
    running     = { chance = 50,    amount = 3 },
    scrapyard   = { chance = 50,    amount = 3 },
    cleaning    = { chance = 50,    amount = 3 },
    workout     = { chance = 50,    amount = 3 },
    kitchen     = { chance = 50,    amount = 3 },
    electrical  = { chance = 50,    amount = 3 },
...
Config.PrisonerPedShop = {
    [1] = {
        ...
        header = 'Mes',
        text = 'Leuk om een opstand te starten.',
        cost = { item = 'prisonmeth', amount = 24 }
    },
    [2] = {
        item = 'weapon_snspistol',
        header = 'Pistol',
        text = 'Om jezelf te beschermen hierbinnen',
        cost = { item = 'prisonmeth', amount = 34 }
    },
    [3] = {
        item = 'pistol_ammo',
        header = 'Pistool kogels.',
        text = 'In geval je niet toekomt met 1 clip.',
        cost = { item = 'prisonwine', amount = 14 }
    },
    [4] = {
        item = 'black_phone',
        header = 'Gsm',
        text = 'Om contact te maken met hierbuiten',
...
Config.Minigames = {
    ThermiteSettings = {
        correctBlocks = 10, -- correctBlocks = Number of correct blocks the player needs to click
        incorrectBlocks = 4, -- incorrectBlocks = number of incorrect blocks after which the game will fail
        timetoShow = 10, -- timetoShow = time in secs for which the right blocks will be shown
        timetoLose = 24 -- timetoLose = maximum time after timetoshow expires for player to select the right blocks
    },
    VarSettings = {
        varBlocks = 4, -- Amount of blocks displayed during the VAR Hack minigame
    }
}
