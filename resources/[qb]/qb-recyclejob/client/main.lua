  ...
  if Config.UseTarget then
    ...
    entranceZone:onPlayerInOut(function(isPointInside)
      if isPointInside then
        --exports['jg-textui']:DrawText(Lang:t("text.point_enter_warehouse"), 'left')
        exports['jg-textui']:DrawText("[E] Ga recycle binnen")
      else
...
local function RegisterExitTarget()
  ...
  if Config.UseTarget then
    ...
    exitZone:onPlayerInOut(function(isPointInside)
      if isPointInside then
        --exports['jg-textui']:DrawText(Lang:t("text.point_exit_warehouse"), 'left')
        exports['jg-textui']:DrawText("[E] Ga naar buiten")
      else
        exports['jg-textui']:HideText()
        --exports['jg-textui']:HideText()
      end
...
local function RegisterDutyTarget()
  ...
  if Config.UseTarget then
    ...
    dutyZone:onPlayerInOut(function(isPointInside)
      if isPointInside then
        --exports['jg-textui']:DrawText(GetDutyTargetText(), 'left')
        exports['jg-textui']:DrawText("[E] Starten met recycle")
      else
        exports['jg-textui']:HideText()
        --exports['jg-textui']:HideText()
      end
  ...
  if Config.UseTarget then
    ...
    deliveryZone:onPlayerInOut(function(isPointInside)
      if isPointInside and carryPackage then
        exports['jg-textui']:DrawText("[E] pakket uitpakken")
      else
        exports['jg-textui']:HideText()
      end
...
function RegisterPickupTarget(coords)
  ...
  if Config.UseTarget then
    ...
    pickupZone:onPlayerInOut(function(isPointInside)
      if isPointInside then
        --exports['jg-textui']:DrawText( Lang:t("text.point_get_package"), 'left')
       -- exports['jg-textui']:DrawText("[E] Neem pakket")
      else
        --exports['jg-textui']:HideText()
        --exports['jg-textui']:HideText()
      end
...
local function DrawPackageLocationBlip()
  ...
  -- QBCore.Functions.DrawText3D(packageCoords.x, packageCoords.y, packageCoords.z, "[E] Neem pakket")
      ...
      if onDuty then
        ...
        if isInsideDeliveryZone and carryPackage then
          ...
          if IsControlJustReleased(0, 38) then
            ...
            Wait(6800)
            QBCore.Functions.Notify(Lang:t("text.volgende"), 'success')
            exports['jg-textui']:HideText()
          end
        end
      end
